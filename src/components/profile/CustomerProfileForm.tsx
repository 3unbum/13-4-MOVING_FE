...
export default function CustomerProfileForm() {
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="pc:gap-8 flex w-full flex-col gap-5">
      <div className="flex flex-col gap-4">
        <span className="text-16 text-black-black-400 pc:text-20 font-semibold">프로필 이미지</span>
        <Controller
          name="image"
          control={control}
          render={({ field }) => (
      ...
      <div className="flex flex-col gap-6">
        <div className="pc:gap-1 flex flex-col gap-2">
          <span className="text-16 text-black-black-400 pc:text-20 font-semibold">이용 서비스</span>
